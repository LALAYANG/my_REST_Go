...
log_dir_name_port = os.path.join(log_dir,name + "_" + tool + "_" + port)
Path(log_dir_name_port).mkdir(parents=True, exist_ok=True)
...
subprocess.call('mv jacoco_'+str(port)+'_*.exec ' + "data/" + services[k], shell=True)
subprocess.call('mv ' + os.path.join(log_dir,'log_'+str(port)+'*') + " data/" + services[k], shell=True)
        ...
        if '_1.csv' in dir_file:
            with open(os.path.join(mypath, dir_file)) as f:
                ...
                for line in lines:
                    ...
                    # print(c_branch[0],t_branch[0],c_line[0],t_line[0] ,c_method[0],t_method[0])
            ...
            with open(os.path.join(mypath, dir_file)) as f:
                ...
                for line in lines:
                    ...
                    # print(c_branch[1],t_branch[1],c_line[1],t_line[1] ,c_method[1],t_method[1],2222)
            ...
            for uni in unique:
                ...
                if flag:
                    crucial = crucial + 1
res = ""
# print(c_branch,t_branch,c_line,t_line ,c_method,t_method)
...
subprocess.call('mv ' + "data/" + services[k] + "/* " + log_dir_name_port, shell=True)
